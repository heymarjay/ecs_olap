...
SELECT c.coffee_id
	  ...
	  ,c.[farm] AS 'Farm Name'
      ,c.[lot_number] AS 'Lot Number'
      ,c.[mill] AS 'Mill'
      ,c.[ico_number] AS 'ICO Number'
      ,c.[company] AS 'Company'
      ,c.[altitude_min] AS 'Minimum Altitude'
      ,c.[altitude_max] AS 'Maximum Altitude'
      ,c.[region] AS 'Region'
      ,c.[producer] AS 'Producer'
      ,c.[bag_number] AS 'Number of Bags'
      ,c.[bag_weight] AS 'Bag Weight'
      ,c.[country_partner] AS 'In-Country Partner'
      ,c.[harvest_year] AS 'Harvest Year'
      ,c.[grading_date] AS 'Grading Date'
	  ...
	  ,ce.[expiration] AS 'Expiration'
      ,ce.[certification_body] AS 'Certification Body'
      ,ce.[certification_address] AS 'Certification Address'
      ,ce.[certification_contact] AS 'Certification Contact'
...
JOIN f_certification AS ce ON c.coffee_id=ce.coffee_id

...
CREATE DATABASE [ECS]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ECS', FILENAME = N'D:\DB_Data_Files\ECS.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 16384KB ) -- CHANGE DIRECTORY
 LOG ON 
( NAME = N'ECS_log', FILENAME = N'E:\DB_Log_Files\ECS_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 16384KB ) -- CHANGE DIRECTORY
GO

ALTER DATABASE [ECS] SET COMPATIBILITY_LEVEL = 120
GO
...
ALTER DATABASE [ECS] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [ECS] SET CURSOR_DEFAULT  GLOBAL 
GO
...
ALTER DATABASE [ECS] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [ECS] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO

ALTER DATABASE [ECS] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [ECS] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [ECS] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [ECS] SET RECOVERY SIMPLE 
GO

ALTER DATABASE [ECS] SET  MULTI_USER 
GO

ALTER DATABASE [ECS] SET PAGE_VERIFY CHECKSUM  
GO

ALTER DATABASE [ECS] SET DB_CHAINING OFF 
GO

ALTER DATABASE [ECS] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [ECS] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO

ALTER DATABASE [ECS] SET DELAYED_DURABILITY = DISABLED 
GO

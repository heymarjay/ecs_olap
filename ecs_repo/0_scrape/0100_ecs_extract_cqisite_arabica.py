#Credits to jldbc https://github.com/jldbc/coffee-quality-database/tree/master/data
#Tweaked by heymarjay 20200407
#Scripts\pip.exe install selenium
#Scripts\pip.exe install beautifulsoup4
#Scripts\pip.exe install pandas
#Scripts\pip.exe install lxml
...
login_email = 'marjayusername@gmail.com'
login_password = 'marjaypassword'
